...
// Printer name
#define CUSTOM_MENDEL_NAME "Green Machine"
...
#define FILAMENTCHANGE_FINALRETRACT -105

#define FILAMENTCHANGE_FIRSTFEED 90 //E distance in mm for fast filament loading sequence used used in filament change (M600)
